...
% ResNet class with cross entropy objective function
    ...
    methods
        function obj = ResNetSoftMax(i_numHiddenLayers, i_inputLayerSize, i_outputLayerSize, i_hiddenLayersSize, i_gamma, h, initScaler, i_testMode)
            % ResNet constructor
            obj.tm = i_testMode;
