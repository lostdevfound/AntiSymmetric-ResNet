...
trainCycles = 2900000;       % default 400000
eta = 0.003;           % good default 0.0005 or 0.003
initScaler = 0.05;
neurons = 15;
layers = 4;
...
% normW2 = norm(net.arrayWeights{2},2);
% normW3 = norm(net.arrayWeights{3},2);
% normW4 = norm(net.arrayWeights{4},2);
% normW5 = norm(net.arrayWeights{5},2);
% normW6 = norm(net.arrayWeights{6},2);
% normW7 = norm(net.arrayWeights{7},2);
% normW8 = norm(net.arrayWeights{8},2);
% normW9 = norm(net.arrayWeights{9},2);
% normW10 = norm(net.arrayWeights{30},2);
% normRes = [normW2, normW3, normW4, normW5, normW6,normW7,normW8,normW9, normW10]
%
%              Perturbation part
%
avgNorm = 0;
